...
```powershell
docker build -t prashantdey/kubeathrix:api-0.2.3 -f services/api/Dockerfile .
docker build -t prashantdey/kubeathrix:console-0.2.3 -f apps/console/Dockerfile .
docker build -t prashantdey/kubeathrix:operator-0.2.3 -f operator/Dockerfile .
```
...
```powershell
docker login
docker push prashantdey/kubeathrix:api-0.2.3
docker push prashantdey/kubeathrix:console-0.2.3
docker push prashantdey/kubeathrix:operator-0.2.3
```
<!-- x-release-please-end -->
