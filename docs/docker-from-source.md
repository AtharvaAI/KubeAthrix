...
```powershell
docker build -t prashantdey/kubeathrix:api-0.1.0 -f services/api/Dockerfile .
docker build -t prashantdey/kubeathrix:console-0.1.0 -f apps/console/Dockerfile .
docker build -t prashantdey/kubeathrix:operator-0.1.0 -f operator/Dockerfile .
```
...
```powershell
docker login
docker push prashantdey/kubeathrix:api-0.1.0
docker push prashantdey/kubeathrix:console-0.1.0
docker push prashantdey/kubeathrix:operator-0.1.0
```
<!-- x-release-please-end -->
