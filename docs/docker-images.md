...
| --- | --- | --- |
| API | `api-0.2.1` | `api-latest` |
| Console | `console-0.2.1` | `console-latest` |
| Operator | `operator-0.2.1` | `operator-latest` |
...
<!-- x-release-please-start-version -->
```powershell
docker pull docker.io/prashantdey/kubeathrix:api-0.2.1
docker pull docker.io/prashantdey/kubeathrix:console-0.2.1
docker pull docker.io/prashantdey/kubeathrix:operator-0.2.1
```
<!-- x-release-please-end -->
